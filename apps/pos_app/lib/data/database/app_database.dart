        ...
        onUpgrade: (m, from, to) async {
          ...
          if (from < 8) {
            await _addColumnIfMissing(
                m, categories, categories.memberDiscountEligible);
            await _addColumnIfMissing(
                m, categories, categories.pointsEarnEligible);
            await _addColumnIfMissing(
                m, categories, categories.pointsRedeemEligible);
            await _addColumnIfMissing(
                m, products, products.memberDiscountEligible);
